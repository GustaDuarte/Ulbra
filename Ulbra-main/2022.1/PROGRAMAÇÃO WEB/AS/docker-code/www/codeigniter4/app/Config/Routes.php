...
$routes->get('/api/client', 'Client::listClientsApi');
...
//PESQUISA NA AREA ADMINISTRATIVA
$routes->add('/admin/client/search', 'Admin\Client::searchClient');
$routes->add('/admin/client/search-action', 'Admin\Client::searchClientAction');

//AREA ADMINISTRATIVA CONTATOS
