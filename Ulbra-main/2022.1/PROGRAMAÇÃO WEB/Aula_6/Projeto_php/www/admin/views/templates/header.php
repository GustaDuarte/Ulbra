    ...
    <section class="row">
        <nav class="col-md-4">
            ...
            <ul class="nav flex-column">
                ...
                <h3>Clientes</h3>
                <li class="nav-item">
                    <a id="list" class="nav-link" href="?controller=clients&action=listClients">Lista Clientes</a>
                </li>
                <li class="nav-item">
                    <a id="insert" class="nav-link" href="?controller=clients&action=insertClient"> -> Novo Clientes</a>
                </li>
        </nav>
